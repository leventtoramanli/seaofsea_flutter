...
class _CompanyShowcasePageState extends State<CompanyShowcasePage> {
  ...
  Widget _buildVisitorChart() {
    return Container(
      ...
      child: const Center(child: Text('📊 Visitor Chart Placeholder')),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildDashboardCard('Applications', '12', Icons.assignment),
              const SizedBox(width: 12),
              _buildDashboardCard('Messages', '8', Icons.message),
            ],
          ),
          const SizedBox(height: 16),
          _buildVisitorChart(),
